 ...
 max-md:max-w-full"
          ...
          <div className="ml-5 w-6/12 max-md:ml-0 max-md:w-full">
            <video
              ...
              loop
              muted
              className="object-contain w-full rounded-3xl aspect-[1.3]  max-md:mt-10 max-md:max-w-full transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-xl"
            />
          </div>
        </div>
      </div>
